"""example**.py
    ...
    + 11/20/16 (mac): Extract from generate_input.py (created 11/7/16).
...
params = {
    ...
    "VC_filename" : os.path.join(generate_input.data_dir_h2,"run0164-JISP16-ob-13/VC-ob-13-20.bin"),

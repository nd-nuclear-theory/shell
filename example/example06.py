...
params = {
    ...
    # stored input TBMEs
    "VNN_filename" : os.path.join(generate_input.data_dir_h2,"run0164-ob-9/JISP16-tb-20.bin"),
    "VC_filename" : os.path.join(generate_input.data_dir_h2,"run0164-ob-9/VC-tb-20.bin"),
